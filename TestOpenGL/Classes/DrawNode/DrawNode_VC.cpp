...
#include "DrawNode_VC.h"
USING_NS_CC;

DrawNode_VC::DrawNode_VC()
: _buffer(nullptr)
{
}
...
void DrawNode_VC::onDraw(const Mat4 &transform, uint32_t flags)
{
